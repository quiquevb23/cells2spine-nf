...
process CSIDE {
    ...
    input:
    val ref_level; val ref_label; val masked_celltypes
    val conditions; val samples; val conditions_map; val condition_order
    val regions                       // params.areas, or [] for whole-sample
    path cell2loc_map                 // "cell2location_map" dir from CELL2LOC_OWNDATA
    path coords                       // "coords" dir from EXTRACT_SPATIAL_INPUTS
    path delineation                  // "delineation" dir, or empty list if not configured
